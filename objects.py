...
class cbfs(param.Parameterized):
    ...
    def call_load_db(self, count,file_input=None):
    ...
    def build_ui(self):
        ...
        button_clearhistory.on_click(self.clr_history)
        inp = pn.widgets.TextInput( placeholder='Enter text here…')

        bound_button_load = pn.bind(self.call_load_db, button_load.param.clicks)
